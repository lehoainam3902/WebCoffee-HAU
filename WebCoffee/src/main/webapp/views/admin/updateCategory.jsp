			...
			<div class="main-content-inner">
			    <div class="row">
			        ...
			        <div class="col-lg-12 mt-5">
			            <div class="card">
			                <div class="card-body">
			                    <h4 class="header-title">Cập nhật loại sản phẩm</h4>
			                    <form action="/WebCoffee/update-category" class="row g-3" method="post" onsubmit="return validateForm()">
			                        <div class="col-12">
			                            <label>Mã sản phẩm</label>
			                            <input type="number" name="id" class="form-control" value="${category.id}" readonly>
			                        </div>
	...
	<script>
	    function validateForm() {
	        ...
	        if (categoryName.trim() === "") {
	            nameError.textContent = "Tên loại sản phẩm không được để trống.";
	            return false;
	        } else {
