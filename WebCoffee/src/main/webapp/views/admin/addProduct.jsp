...
<div class="main-content-inner">
        ...
        <div class="col-lg-12 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="addProductForm" action="/WebCoffee/add-product" class="row g-3" method="post">
                        <div class="col-12">
                            <label>Mã sản phẩm</label>
                            <input type="number" name="id" id="productId" class="form-control">
                            <small class="text-danger d-none" id="productIdError">Vui lòng không để trống mã sản phẩm.</small>
                        </div>
                        <div class="col-12 mt-4">
                            <label>Tên sản phẩm</label>
                            <input type="text" name="name" id="productName" class="form-control">
                            <small class="text-danger d-none" id="productNameError">Vui lòng không để trống tên sản phẩm.</small>
                        </div>
                        <div class="col-12 mt-4">
                            <label>Giá</label>
                            <input type="text" name="price" id="productPrice" class="form-control">
                            <small class="text-danger d-none" id="productPriceError">Vui lòng không để trống giá.</small>
                        </div>
                        <div class="col-12 mt-4">
                            <label>Ảnh Minh Họa</label>
                            <input type="text" name="thumbnail" id="productThumbnail" class="form-control">
                            <small class="text-danger d-none" id="productThumbnailError">Vui lòng không để trống ảnh.</small>
                        </div>
                        <div class="col-12 mt-4">
                            <label>Mã Loại Sản Phẩm</label>
                            <input type="text" name="category_id" id="productCategory" class="form-control">
                            <small class="text-danger d-none" id="productCategoryError">Vui lòng không để trống mã loại sản phẩm.</small>
                        </div>
                        <div class="col-12 mt-4">
                            <label>Mô Tả</label>
    ...
    document.getElementById('addProductForm').addEventListener('submit', function(event) {
        ...
        if (productId.value.trim() === '') {
            ...
            document.getElementById('productIdError').classList.remove('d-none');
        } else {
            document.getElementById('productIdError').classList.add('d-none');
        }
        ...
        if (productThumbnail.value.trim() === '') {
            event.preventDefault();
            document.getElementById('productThumbnailError').classList.remove('d-none');
        } else {
            document.getElementById('productThumbnailError').classList.add('d-none');
        }
