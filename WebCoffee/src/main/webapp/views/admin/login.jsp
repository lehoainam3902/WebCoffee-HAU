	...
	<div class="login-area login-s2">
	    <div class="container">
	        <div class="login-box ptb--100">
	            <form id="loginForm" action="/WebCoffee/login" method="post">
	                ...
	                <div class="login-form-body">
	                    <div class="form-gp" hidden="">
	                        <label for="yourId">Role_id</label>
	                        <input type="text" name="role_id" id="yourId" value="1">
	                        <i class="ti-email"></i>
	                    </div>
	                    <div class="form-gp">
	                        <label for="yourUsername">Tên đăng nhập</label>
	                    ...
	                    <c:if test="${requestScope.loginError != null}">
							...
							<c:if test="${requestScope.succMsg = null}">
							<p class="alert alert-danger">${requestScope.succMsg}</p>
						</c:if>
