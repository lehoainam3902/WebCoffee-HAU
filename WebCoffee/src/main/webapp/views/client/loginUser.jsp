	...
	<div class="login-area login-s2">
		<div class="container">
			<div class="login-box ptb--100">
				<form action="/WebCoffee/user-login" method="post">
					...
					<div class="login-form-body">
						...
						<div class="form-footer text-center mt-5">
							<p class="text-muted">
								Bạn không có tài khoản? <a href="/WebCoffee/views/client/registerUser.jsp">Đăng ký</a>
							</p>
						</div>
					</div>
				</form>
