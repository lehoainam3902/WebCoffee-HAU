...
<body>
					...
					<div class="col-sm-6">
						<div class="breadcrumbs-area clearfix">
							...
							<ul class="breadcrumbs pull-left">
								...
								<li><span>Cập nhật quyền</span></li>
							</ul>
						</div>
					</div>
				...
				<div class="main-content-inner">
				    <div class="row">
				        ...
				        <div class="col-lg-12 mt-5">
				            <div class="card">
				                <div class="card-body">
				                    <h4 class="header-title">Cập nhật Quyền</h4>
				                    <form id="updateRoleForm" action="/WebCoffee/update-role" class="row g-3" method="post">
				                        <div class="col-12">
				                            <label>Mã</label>
				                            <input type="number" name="id" class="form-control" value="${role.id}">
				                            <small class="text-danger d-none" id="idError">Vui lòng không để trống mã.</small>
				                        </div>
				                        <div class="col-12 mt-4">
				                            <label>Tên Phân Quyền</label>
				                            <input type="text" name="name" class="form-control" value="${role.name}">
				                            <small class="text-danger d-none" id="nameError">Vui lòng không để trống tên phân quyền.</small>
				                        </div>
				                        <div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var form = document.querySelector('#updateRoleForm');
