...
<body>
					...
					<div class="col-sm-6">
						<div class="breadcrumbs-area clearfix">
							...
							<ul class="breadcrumbs pull-left">
								...
								<li><span>Thêm mới loại sản phẩm</span></li>
							</ul>
						</div>
					</div>
			...
			<div class="main-content-inner">
			    <div class="row">
			        ...
			        <div class="col-lg-12 mt-5">
			            <div class="card">
			                <div class="card-body">
			                    <h4 class="header-title">Thêm mới loại sản phẩm</h4>
			                    <form id="add-category-form" action="/WebCoffee/add-category" class="row g-3" method="post">
									<div class="col-12">
									    <label>Mã loại sản phẩm</label>
									    <input type="number" name="id" id="id" class="form-control">
									    <div id="id-error" style="color: red; display: none;">Không để trống mã sản phẩm</div>
									</div>
			                        <div class="col-12 mt-4">
			                            <label>Tên loại sản phẩm</label> 
			                            <input type="text" name="name" id="name" class="form-control">
			                            <div id="name-error" style="color: red; display: none;">Không để trống loại sản phẩm</div>
			                        </div>
			                        <div>
   ...
   <script>
        document.getElementById('add-category-form').addEventListener('submit', function(event) {
            ...
            if (!idField.value.trim() || isNaN(idField.value.trim())) {
                idError.style.display = 'block';
                event.preventDefault(); // Prevent form submission if ID is empty or not a number
            } else {
