...
<body>
					...
					<div class="col-sm-6">
						<div class="breadcrumbs-area clearfix">
							...
							<ul class="breadcrumbs pull-left">
								...
								<li><span>Thêm mới quyền</span></li>
							</ul>
						</div>
					</div>
				...
				<div class="main-content-inner">
				    <div class="row">
				        ...
				        <div class="col-lg-12 mt-5">
				            <div class="card">
				                <div class="card-body">
				                    <h4 class="header-title">Thêm mới quyền</h4>
				                    <form id="addRoleForm" action="/WebCoffee/add-role" class="row g-3" method="post">
				                        <div class="col-12">
				                            <label>Mã</label>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        var form = document.querySelector('#addRoleForm');
