					...
					<div class="col-sm-6">
						<div class="breadcrumbs-area clearfix">
							...
							<ul class="breadcrumbs pull-left">
								...
								<li><span>Thêm mới đơn hàng</span></li>
							</ul>
						</div>
					</div>
			...
			<div class="main-content-inner">
			    <div class="row">
			        ...
			        <div class="col-lg-12 mt-5">
			            <div class="card">
			                <div class="card-body">
			                    <h4 class="header-title">Thêm mới đơn hàng</h4>
			                    <form id="addOrderForm" action="/WebCoffee/add-order" class="row g-3" method="post">
			                        <div class="col-12">
			                            <label>Mã đơn hàng</label>
			                            <input type="number" name="id" class="form-control">
			                            <small class="text-danger d-none" id="orderIdError">Vui lòng không để trống mã đơn hàng.</small>
			                        </div>
...
<script>
    document.getElementById('addOrderForm').addEventListener('submit', function(event) {
        var orderId = document.getElementsByName('id')[0];
        ...
        if (orderId.value.trim() === '') {
            ...
            document.getElementById('orderIdError').classList.remove('d-none');
        } else {
            document.getElementById('orderIdError').classList.add('d-none');
        }
